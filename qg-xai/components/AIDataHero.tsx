        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">AI & Data</span> for the Intelligent Enterprise
            </h1>
            
            {/* Subheadline */}
            <p className="text-2xl md:text-3xl text-blue-100 leading-relaxed font-medium max-w-4xl mx-auto">
              From governance to GenAI — turning information into foresight and automation.
            </p>
            
            {/* Description */}
            <p className="text-xl md:text-2xl text-blue-200 leading-relaxed max-w-4xl mx-auto">
              Data & AI is not just about reporting. It's about creating an intelligent enterprise where trusted data, applied AI, and emerging technologies combine to deliver foresight, simplify complexity, and accelerate execution.
            </p>
