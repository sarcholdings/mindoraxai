        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight">
              Ready to accelerate your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-300">cloud transformation</span> with SAP S/4HANA Public Cloud?
            </h2>
...
export default CloudServicesClosingCTA;
