  ...
  return (
    <section id="contact" className="section-padding bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-4">
        <div className="mb-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground text-center">Contact Us</h2>
        ...
        <form
          ...
          method="POST"
          target="_blank"
          className="bg-card text-card-foreground rounded-2xl shadow-md border border-border p-8 flex flex-col gap-6"
        >
          <Input
            name="name"
            placeholder="Name*"
            required
            className="border border-input rounded-md px-4 py-3 text-base"
          />
          <Input
            name="email"
            type="email"
          ...
          <Textarea
            ...
            required
          />
          <Button type="submit" className="font-semibold rounded-full px-6 py-3 w-full transition-colors text-base">
