          ...
          <div className="bg-card border-4 border-border/80 dark:border-border/60 rounded-3xl p-8 md:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] relative group hover:border-hero-accent-1/50 hover:shadow-[0_25px_70px_-10px_rgba(255,111,97,0.15)] transition-all duration-500 backdrop-blur-xl">
            ...
            <div className="space-y-3 relative z-10">
              {businessOutcomes.map((item) => (
                <div
                  key={item}
                  className="flex items-start gap-3 rounded-xl border-2 border-border/80 dark:border-border/60 bg-accent px-4 py-4 text-foreground hover:bg-background/50 hover:border-hero-accent-1/60 hover:shadow-lg hover:shadow-hero-accent-1/10 hover:-translate-y-0.5 transition-all duration-300 group/item"
                >
