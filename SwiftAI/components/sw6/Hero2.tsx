        ...
        <div className="max-w-4xl mx-auto text-center">
          <div>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <div className="inline-flex items-center gap-2 w-fit rounded-none border border-hero-accent-2/30 bg-hero-accent-2/10 px-5 py-2 text-sm text-white backdrop-blur-sm">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Button
                ...
                onClick={() => document.getElementById("sw6-capabilities")?.scrollIntoView({ behavior: "smooth" })}
              >
                See Key Features
              ...
              <Button
                ...
                onClick={() => document.getElementById("sw6-platform")?.scrollIntoView({ behavior: "smooth" })}
              >
                Learn More
