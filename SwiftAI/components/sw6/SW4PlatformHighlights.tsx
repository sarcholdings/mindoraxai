...
export function SW4PlatformHighlights() {
  return (
    <section id="sw6-platform" className="py-24 bg-background relative overflow-hidden">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  <div className="rounded-xl border-2 border-border/80 dark:border-border/60 bg-orange-500/10 p-3 text-orange-400 group-hover:border-orange-500/60 transition-colors">
