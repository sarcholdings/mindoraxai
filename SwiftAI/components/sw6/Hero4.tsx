        ...
        <div className="max-w-4xl mx-auto text-center">
          <div>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <div className="inline-flex items-center gap-2 w-fit rounded-none border border-hero-accent-4/30 bg-hero-accent-4/10 px-5 py-2 text-sm text-white backdrop-blur-sm">
