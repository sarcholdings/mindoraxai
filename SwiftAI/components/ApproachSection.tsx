...
const ApproachSection = () => {
  const approaches = [
    {
      title: 'Advise',
      description: 'Define strategy, uncover opportunities, and design the roadmap',
      icon: '🎯',
    ...
    {
      title: 'Implement',
      description: 'Deploy AI, ERP, and platform solutions that transform your core operations',
      icon: '⚡',
    ...
    {
      title: 'Operate',
      description: 'Ensure your systems run efficiently, evolve with your needs, and deliver sustained value using tsi coenctent',
      icon: '🔄',
      ...
      <div className="section-container relative z-10">
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-3 mb-6">
            ...
            <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Our Methodology</span>
            <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
          </div>
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            A comprehensive methodology that ensures your transformation journey delivers lasting results
          </p>
        </div>
