        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground leading-tight">
              What <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dark">SWIFTAI</span> Does for You
            </h2>
          </div>
              ...
              <div key={index} className="group">
                <div className="relative bg-accent/50 rounded-2xl p-6 border border-border hover:shadow-lg hover:border-primary/30 transition-all duration-500 transform hover:-translate-y-2">
                  ...
                  <div className="relative z-10 flex items-start space-x-4">
                    ...
                    <span className="text-lg text-muted-foreground font-medium group-hover:text-foreground transition-colors duration-300 leading-relaxed">
                      {benefit}
                    </span>
                  </div>
                </div>
