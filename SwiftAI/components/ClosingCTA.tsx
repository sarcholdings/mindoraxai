        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-3 mb-6">
              ...
              <span className="text-white/80 font-semibold text-sm uppercase tracking-wider">Let's Work Together</span>
              <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
            </div>
            ...
            <p className="text-xl md:text-2xl text-blue-100 leading-relaxed max-w-4xl mx-auto font-medium">
              We help you advise, implement, and operate technology that drives clarity, speed, and growth.
            </p>
          </div>
