                  ...
                  >
                    ...
                    <div className="relative p-8 md:p-12 lg:p-14 flex flex-col justify-center md:[direction:ltr]">
                      ...
                      <div className="relative z-10 space-y-5">
                        <h3 className="text-2xl md:text-[28px] font-bold text-foreground leading-snug tracking-tight">
                          {project.title}
                        </h3>

                        <div className="flex items-center gap-2">
                          <span className="inline-flex items-center gap-1.5 text-xs font-semibold tracking-wider uppercase text-hero-accent-1">
                            <span
