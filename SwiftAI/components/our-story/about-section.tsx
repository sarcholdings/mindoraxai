          ...
          <div className="flex justify-between items-center mb-8 w-[85%] absolute lg:top-4 md:top-0 sm:-top-2 -top-3 z-10">
            ...
            <div className="flex gap-4">
              <TimelineContent
                ...
                timelineRef={heroRef}
                customVariants={revealVariants}
                href="https://www.linkedin.com/company/quanta-global"
                target="_blank"
              ...
              <TimelineContent
                ...
                timelineRef={heroRef}
                customVariants={revealVariants}
                href="https://twitter.com/quanta_global"
                target="_blank"
                rel="noopener noreferrer"
                className="md:w-8 md:h-8 sm:w-6 w-5 sm:h-6 h-5 border border-gray-200 bg-gray-100 rounded-lg flex items-center justify-center cursor-pointer"
              >
          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
                ...
                <span className="text-gray-600">enterprises transformed</span>
              </div>
            </TimelineContent>
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              ...
              >
                ...
                <span className="text-gray-600 uppercase">countries</span>
              </TimelineContent>
              <TimelineContent
                as="div"
                animationNum={7}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="text-right">
              ...
              >
                Enterprise Orchestration | AI Transformation
              </TimelineContent>
              ...
              >
                <p className="text-gray-900 font-medium mb-4">
                  Ready to orchestrate your transformation with clarity and speed?
                </p>
              </TimelineContent>
              ...
              >
                START YOUR JOURNEY <ArrowRight className="" />
              </TimelineContent>
            </div>
          </div>
        </div>
