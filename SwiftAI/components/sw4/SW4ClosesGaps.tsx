      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="mt-12 overflow-hidden rounded-2xl border-2 border-border/80 dark:border-border/60 bg-card">
          ...
          {somGapClosers.map((item) => (
            <div
              key={item.area}
              className="grid gap-4 border-t border-border/60 px-6 py-5 md:grid-cols-[1.1fr_1fr_auto_1.1fr] md:items-center hover:bg-accent/50 transition-colors duration-300"
            >
              <div>
              ...
              <div className="hidden md:flex justify-center">
                <div className="rounded-full border border-hero-accent-1/20 bg-hero-accent-1/10 p-2 text-hero-accent-1">
